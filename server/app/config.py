...
class Settings(BaseSettings):
    APP_NAME: str = os.getenv("APP_NAME", "Baby Monitor Central Server")
    ...
    # Authorized Devices (ID -> Secret Token)
    ...
    MAX_AUTH_FAILURES: int = int(os.getenv("MAX_AUTH_FAILURES", "5"))
    ...
    HEARTBEAT_TIMEOUT: float = float(os.getenv("HEARTBEAT_TIMEOUT", "5.0"))
